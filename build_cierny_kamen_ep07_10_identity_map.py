...
ROWS = [
    ...
    ("07/02LP", "Dogyho uterák", "v pyžame s uterákom", "DOGY", ["Osobná rekvizita"], None, None),
    ("07/02LP", "Dogyho zubná kefka", "s uterákom a kefkou", "DOGY", ["Osobná rekvizita"], None, None),
    ("07/03", "Dogyho uterák", "Dogy stojí v uteráku", "DOGY", ["Osobná rekvizita"], None, None),
    ...
    ("07/12", "Andyho fľaša piva", "Kašeľ zapije pivom", "ANDY", ["Osobná rekvizita"], None, None),
    ...
    ("07/30", "Veronikin osobný mobil", "pozerá do mobilu", "VERONIKA", ["Osobná rekvizita"], "veronika-mobile", "Potvrdiť, či sa Veronika líči podľa zrkadla alebo podľa mobilu; scenár uvádza alternatívu."),
    ...
    ("07/51", "Andyho fľaša piva", "Otvára si v fľašu", "ANDY", ["Osobná rekvizita"], None, None),
    ...
    ("08/29", "Lukášov pracovný pickup", "zastaví auto, z ktorého vystupuje Lukáš", "LUKÁŠ", ["Auto", "Osobná rekvizita"], "lukas-pickup", "Potvrdiť, že Lukáš v 08/29 prichádza na tom istom pracovnom pickupe ako v 08/16 a 08/21."),
    ("08/31", "Lukášov pracovný pickup", "Alex trucovito sedí v Lukášovom aute", "LUKÁŠ", ["Auto", "Osobná rekvizita"], "lukas-pickup", "Potvrdiť, že Lukášovo auto v 08/31 je ten istý pracovný pickup ako v 08/16 a 08/21."),
    ...
    ("09/26", "Sárin osobný mobil", "pozerajú nejakú storku", "SÁRA", ["Osobná rekvizita"], "sara-mobile", "Potvrdiť, na čí mobil Sára, Lola a Popy pozerajú storku; pracovná identita je zatiaľ vedená pri Sáre."),
    ...
    ("09/29", "Oblek pre Alexa od Sáry", "priehľadnom obale oblek pre Alexa", "ALEX", ["Osobná rekvizita"], None, "Upresniť vzhľad a veľkosť obleku, ktorý Sára priniesla Alexovi."),
    ...
    ("10/03LP", "Alkoholické nápoje na párty u Alexa", "pije alkohol", None, [], None, None),
...
def main():
    ...
    for scene_id, stable_name, phrase, owner, categories, group, question in ROWS:
        ...
        records.append({
            ...
            "physical_presence": not bool(question and "iba obrazné" in question),
