...
DOCUMENT = json.loads((ROOT / "riverdale_schedule_2026-08-28.json").read_text(encoding="utf-8"))
ROWS = DOCUMENT["rows"]


class RiverdaleAugust28ScheduleTests(unittest.TestCase):
    def test_source_is_unique_and_selects_seven_shooting_days(self):
        self.assertEqual(DOCUMENT["source"]["dated"], "2026-08-28")
