...
class September10ScheduleTests(unittest.TestCase):
    ...
    def test_september_19_plans(self):
        self.check_plan("dunaj_schedule_2026-09-19.json", 435, [
            "2026-09-20", "2026-09-21", "2026-09-22", "2026-09-23",
            "2026-09-24", "2026-09-25", "2026-09-26",
        ], as_of="2026-09-19")
        self.check_plan("riverdale_schedule_2026-09-19.json", 355, [
            "2026-09-20", "2026-09-22", "2026-09-24", "2026-09-25",
            "2026-09-26", "2026-09-27", "2026-09-30",
        ], as_of="2026-09-19")
        self.check_plan("dok4_schedule_2026-09-19.json", 826, [
