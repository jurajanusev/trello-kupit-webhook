...
DOCUMENT = json.loads(
    (ROOT / "dunaj_schedule_2026-09-06.json").read_text(encoding="utf-8")
)
ROWS = DOCUMENT["rows"]


class DunajSeptember6ScheduleTests(unittest.TestCase):
    def test_source_is_unique_and_selects_seven_shooting_days(self):
        self.assertEqual(
            DOCUMENT["source"], "predbežná dispo DUNAJ 17 z 6. 9. 2026"
        )
